...
To sit beside the single-shape rows at the **same data budget**, a mixed policy trained on all four shapes CW at once: ~100k rows TOTAL round-robined across triangle/square/pentagon/circle (~25k each, vs ~100k of *one* shape for the single runs), init 300k + DAgger×1 with ~60 episodes TOTAL (15 seeds × 4 shapes, vs 60 on one shape for the single runs), same soft-v2 recipe, CW. Evaluated on all shapes both CW and CCW. This isolates the single variable *shape-diversity of the training set* at fixed budget — i.e. does spreading the budget over 4 shapes beat concentrating it on 1?

**Mixed FINAL — traverse / dist mean (m), 50 seeds:**

| eval dir | triangle | square | pentagon | circle | star | TOTAL |
|---|---|---|---|---|---|---|
| **CW** | 44/50 · 0.174 | 50/50 · 0.186 | 50/50 · 0.181 | 49/50 · 0.086 | 44/50 · 0.198 | **237/250** |
| **CCW** | 49/50 · 0.160 | 50/50 · 0.179 | 50/50 · 0.176 | 49/50 · 0.084 | 48/50 · 0.186 | **246/250** |
